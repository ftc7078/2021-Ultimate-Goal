...
public class FlywheelMC {
    static final float NANOSECONDS_PER_SECOND = 1000000000;



    private double powerScale =  0.0002;
    ...
    double lookAheadTime = 0.075;


    boolean backwardsEncoder=false;
    ...
    public FlywheelMC(DcMotorEx setMotor) {
        motor = setMotor;
    }

    public FlywheelMC(HardwareMap hardwareMap, String motorString, double maxSpeedIn) {
    ...
    public FlywheelMC(DcMotorEx setMotor, double maxSpeedIn) {
        motor = setMotor;
        maxSpeed = maxSpeedIn;
    }

    public boolean isBackwardsEncoder() {
        return backwardsEncoder;
    }



    public void setBackwardsEncoder(boolean backwardsEncoder) {
        this.backwardsEncoder = backwardsEncoder;
    }
    ...
    public void autoAdjust() {
        ...
        velocitySoon = currentVelocity + (accelleration * lookAheadTime);
